function init() {
    ...
    function createPointInstances(size, transparent, opacity, sizeAttenuation, color) {
      ...
      var texture1 = loader.load("particles/snowflake1_t.png");
      var texture2 = loader.load("particles/snowflake2_t.png");
      var texture3 = loader.load("particles/snowflake3_t.png");
      var texture4 = loader.load("particles/snowflake5_t.png");
